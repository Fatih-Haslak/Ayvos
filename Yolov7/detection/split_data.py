...
full_data_path = 'datalarim/' # resim ve etiketlerının beraber bulundugu folder
extension_allowed = '.png'    # resimlerin uzantısı
split_percentage = 90         #yüzde x' kadar train yap demek
